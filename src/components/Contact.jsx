    ...
    <div className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
        ...
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/2031732d-7cac-4813-8abc-d25986371944" method="POST" className="flex flex-col w-full md:w-1/2">
                    <input type="text" name="name" placeholder="Enter your name" className="p-2 bg-transparent border rounded-md text-white
                    focus:outline-none"/>
                    <input type="text" name="email" placeholder="Enter your email" className="my-4 p-2 bg-transparent border rounded-md text-white
                    focus:outline-none"/>
